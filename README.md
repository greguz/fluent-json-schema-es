...
This project is the ESM version of the official package [fluent-json-schema](https://github.com/fastify/fluent-json-schema).

This project will be just a conversion from its father, and no other features will be added. The motivation is to provide a better compatibility with newer versions of Node.js and TypeScript.

Hopefully, those changes will be merged inside the source project in the future.
...
- Source code rewritten in pure ESM
- CommonJS code generated by [`rollup`](https://github.com/rollup/rollup)
- Package contains only production files (optimal download size)
- Support TypeScript>=4.8 with `Node16`/`NodeNext` module resolution
- Code coverage provided by [`c8`](https://github.com/bcoe/c8)
